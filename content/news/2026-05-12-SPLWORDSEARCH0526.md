...
layout = "game-embed"
modal-exclude = false
more-games = ["slide", "sudoku", "crossword"]
pinned = false
...
Find thematic words hidden in the grid. If you want to play without distractions on desktop, click on the full-screen icon in the top-left corner of the puzzle. Play Spotlight PA games here or on our mobile app — available for free in the [Apple App Store](https://apps.apple.com/us/app/spotlight-pa/id6498866659) and [Google Play Store](https://play.google.com/store/apps/details?id=com.spotlightpa.digestapp&pli=1).
