...
The five-member Legislative Reapportionment Commission, meanwhile, draws the state House and Senate maps. Anyone may challenge the final maps, and if that happens, the map will be sent to the high court for review.

In 2011, the Republican-majority court rejected the commission’s first maps for splitting too many municipalities in violation of the Pennsylvania Constitution.
