+++
authors = ["Stephen Caruso", "Katie Meyer", "Jaxon White"]
blurb = "Law enforcement can’t take any action for four months, which gives the legislature a window to finally regulate the devices."
byline = "Stephen Caruso, Katie Meyer, and Jaxon White of Spotlight PA"
description = "Law enforcement can’t take any action for four months, which gives the legislature a window to finally regulate the devices."
draft = false
feed-exclude = false
...
internal-id = "SPLSKILLRULING0626"
kicker = "The Capitol"
modal-exclude = false
pinned = false
published = 2026-06-15T17:39:32.706-04:00
slug = "skill-games-illegal-pennsylvania-supreme-court-ruling-capitol"
suppress-ads = false
suppress-date = false
title = "Skill games are slot machines, must adhere to Pa.’s gambling law, state Supreme Court rules"
title-tag = "Skill games are gambling devices: PA Supreme Court"
topics = ["The Capitol"]
+++
...
Taxing skill games as part of a regulation scheme could eventually bring in more than $1 billion annually in much-needed revenue, according to the <a href="https://www.ifo.state.pa.us/download.cfm?file=Resources/Documents/BB_Regulate_and_Tax_Skill_Games_2026_02.pdf">Independent Fiscal Office</a>. Should the legislature fail to act, the devices would be subject to seizure by law enforcement.
...
Complicating talks over the years are wealthy interests’ strong preferences: Casinos support a higher tax rate for skill games, and the skills industry argues such a rate would sink them and harm the small businesses and veterans’ organizations that depend on the money.
