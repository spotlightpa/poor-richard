...
<strong>» If you value Spotlight PA’s nonpartisan election reporting that puts voters first</strong>, please help support us in this critical year by making a tax-deductible gift at spotlight.org/donate, or send a check to: Spotlight PA, PO Box 11728, Harrisburg, PA 17108-1728.
...
- <a href="#spl-heading-9">How we work to be fair</a>
...
<h2 id="spl-heading-9">How we work to be fair</h2>

We apply the same level of scrutiny to all candidates for office, regardless of their political affiliation. That means thoroughly researching their backgrounds, asking tough questions to give voters the information they need to make an informed decision, and informing the public when a candidate or campaign is not being transparent. We are a nonpartisan newsroom and do not endorse political candidates or take any position on a particular policy or political viewpoint. We do not allow anonymous donations, and we fully disclose the source of all funding we receive at <a href="http://spotlightpa.org/support">spotlightpa.org/support</a>.
