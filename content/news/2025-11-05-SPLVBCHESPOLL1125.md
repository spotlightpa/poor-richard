...
blurb = "The county only included major-party voters in its pollbooks, forcing third-party and unaffiliated voters to use provisional ballots or return later."
byline = "Carter Walker of Votebeat"
description = "On Election Day, third-party and unaffiliated voters in Chester County, PA either voted with a provisional ballot or returned later."
draft = false
feed-exclude = false
image = "external/9b02rsyscxwdnw0xpe9w7p3jar.jpeg"
image-credit = "Amanda Berg / For Spotlight PA"
image-description = "Pennsylvania voters wait in line in 2020."
image-gravity = "ce"
internal-id = "SPLVBCHESPOLL1125"
kicker = "Elections"
modal-exclude = false
pinned = false
published = 2025-11-05T16:51:12.258-05:00
slug = "chester-county-pollbook-problem-2025-election-pennsylvania-third-party-elections"
suppress-date = false
title = "What happened with Chester County’s pollbook printing problem?"
title-tag = "Inside Chester County, PA’s pollbook printing problem"
topics = ["Elections"]
+++
...
While many Pennsylvania counties <a href="https://www.votebeat.org/pennsylvania/2025/10/22/electronic-pollbook-knowink-checkin-voters-act-88/">have switched to electronic pollbooks</a> in recent years, Chester County is still using physical paper pollbooks. This means if there is an issue with the printing of those books, additional pollbooks need to be printed and delivered to voting locations, as was the case Tuesday.
...
Hoping to cut down on such rejections, the Department of State announced <a href="https://www.votebeat.org/pennsylvania/2025/07/14/provisional-ballot-envelope-redesign-al-schmidt-philadelphia/">a redesign of the outer envelope earlier this year</a>, starting with Tuesday’s election. Adoption of the new envelope by the counties was voluntary. Chester County said it was using the new version for Tuesday&#39;s election.
