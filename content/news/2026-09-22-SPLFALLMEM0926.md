...
suppress-ads = false
suppress-date = false
title = "An attempt to control what gets reported is an attempt to control what you know. You can fight back."
...
<div class="fru-wrap"><a href="#XKHMBHUN" style="display: none"></a></div><style>.fru-wrap {display: flex; justify-content: center; width: 100%}</style>
